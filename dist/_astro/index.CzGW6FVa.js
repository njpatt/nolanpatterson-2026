 ...
 */ var nt = {
  ...
  re = function (t) {
    var e = t.parent || E,
      i = t.keyframes ? Ur($(t.keyframes)) : at;
    if (Q(t.inherit))
  ...
  Kr = { _start: 0, endTime: ue, totalDuration: ue },
  ut = function u(t, e, i) {
    var r = t.labels,
      n = t._recent || Kr,
      ...
      function (c, d, p) {
        ...
        if (!m) {
          if (((w = e.grid === "auto" ? 0 : (e.grid || [1, ft])[1]), !w)) {
            for (
              b = -ft;
              b < (b = p[w++].getBoundingClientRect().left) && w < _;
            );
            w < _ && w--;
          }
          for (
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              (a = P ? 0 : h % f ? f : h),
              (this._lock = 1),
              (this.render(a || (b ? 0 : A(_ * m)), n, !f)._lock = 0),
              (this._tTime = h),
        ...
        if (
          (this._hasPause &&
            !this._forcing &&
            this._lock < 2 &&
            ((y = $r(this, A(a), A(c))), y && (h -= c - (c = y._start))),
          (this._tTime = h),
          (this._time = c),
          (this._act = !!x),
          this._initted ||
...
var _n = function (t, e, i, r, n, s, a) {
  ...
  oi = function u(t, e, i) {
    ...
    if (
      (T && (!c || !n) && (n = "none"),
      (t._ease = Lt(n, ae.ease)),
      (t._rEase = g && (Lt(g) || t._ease)),
      ...
      for (
        ...
        if (
          ((O = m[b]),
          (F = O._gsap || ni(m)[b]._gsap),
          (t._ptLookup[b] = X = {}),
          Be[F.id] && wt.length && xe(),
          (Y = y === m ? b : y.indexOf(O)),
          D &&
            (I = new D()).init(O, B || S, t, Y, y) !== !1 &&
            ((t._pt = w =
              new j(t._pt, O, I.name, 0, 1, I.render, I, 0, I.priority)),
            I._props.forEach(function (Vt) {
              X[Vt] = w;
            }),
            I.priority && (N = 1)),
          !D || B)
...
var U = (function (u) {
  ...
  function t(i, r, n, s) {
    ...
    var o = a.vars,
      ...
      m = o.scrollTrigger,
      v = r.parent || E,
      y = ($(i) || Ii(i) ? yt(i[0]) : "length" in r) ? [i] : ht(i),
      x,
      T,
      g,
      S,
    ...
    if (
      ...
      if (
        ...
        if (((S = y.length), (w = c && Ji(c)), dt(c)))
          for (b in c) ~lr.indexOf(b) && (O || (O = {}), (O[b] = c[b]));
        for (T = 0; T < S; T++)
          ((g = Te(r, cr)),
            (g.stagger = 0),
            N && (g.easeReverse = N),
 ...
 */ var Pi,
  ...
  Ze = function (t, e, i, r, n, s) {
    ...
    (i
      ? o !== le &&
        (b = d * m - p * _) &&
        ((P = T * (m / b) + g * (-_ / b) + (_ * y - m * v) / b),
        (w = T * (-p / b) + g * (d / b) - (d * y - p * v) / b),
        (T = P),
        (g = w))
      : ((S = Pr(t)),
  ...
  ce = function (t, e) {
    ...
    return (
      ...
      i.svg &&
        ...
        Ze(t, B || f, !!B || i.originIsAbsolute, i.smooth !== !1, b)),
      (g = i.xOrigin || 0),
      (S = i.yOrigin || 0),
      b !== le &&
        ((N = b[0]),
      ...
      (i.renderTransform = i.svg ? $n : wr ? Cr : Gn),
      (i.uncache = 0),
      i
    );
  },
        ...
        if (
              ...
              (P.push(H, 0, a[H]),
                ...
                g.svg
                  ...
                  : ((v = parseFloat(h.split(" ")[2]) || 0),
                    v !== g.zOrigin && bt(this, g, "zOrigin", g.zOrigin, v),
          ...
          if (x || ((l || l === 0) && (c || c === 0) && !Mn.test(h) && _ in a))
            ((m = (f + "").substr((c + "").length)),
              ...
              (this._pt.u = v || 0),
              x && w !== h
                ? ((this._pt.b = f), (this._pt.e = w), (this._pt.r = An))
                : m !== v &&
                  v !== "%" &&
